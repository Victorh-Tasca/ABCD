                            ...
                            <div class="secao-column">
                                <div>
                                    ...
                                    <select name="categoria" >
                                        ...
                                        <?php
                                        $sql_code_categoria = "SELECT * FROM categoria  WHERE id <> 5 ORDER BY nome ASC";
        ...
        if (count($_POST) > 0) {
            if (isset($_POST['submeter'])) {
                ...
                if ($erro) {
                    ...
                    if ($deu_certo) {
                        echo '<p>Arquivo atualizado com sucesso</p>, <a href="planoacao_listagem.php">voltar</a> para página de listagem</p>';
