...
<html>
    ...
    <head>
        <title>Listagem de Documentos - Regularidade Fiscal</title>
        <meta charset="UTF-8">
                                    ...
                                    if ($usuario['privilegio'] == 1) {
                                        ...
                                        <td>
                                            <div class="botoes-comandos">
                                                <a href="regularidadefiscal_alterar.php?id=<?php echo $listagem['id'] ?>"><button id="alterar">Alterar</button></a>
                                                <a href="regularidadefiscal_excluir.php?id=<?php echo $listagem['id'] ?>"><button id="deletar">Excluir</button></a>
                                            </div>
                                        </td>
                                    <?php } ?>
                                </tr>
