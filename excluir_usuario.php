    ...
    <body>
        ...
        <div class="fora-menu">
            ...
            <div class="descricao">
                ...
                <p>Escolha uma das opções abaixo para deletar ou não um usuário no sistema da ABCD.</p>
            </div>
            ...
            <button type="submit" name="sim">Sim</button>
                        ...
                        <a href="listagem_usuario.php"> <button type="submit" >Não</button></a>
                    ...
                    if (count($_POST) > 0) {
                        if (isset($_POST['sim'])) {
                                    ...
                                    $sql_code = "DELETE FROM administrador WHERE id='$id'";
                                    $deu_certo = $mysqli->query($sql_code) or die($mysqli->error);
                                    if ($deu_certo) {
                                        echo '<p class="certo">Usuário deletado com sucesso, <a href="listagem_usuario.php">voltar</a> para página de listagem de usuários</p>';
                                        unset($_POST);
                                        die();
                                    } else {
                                        echo '<p class="error">Erro ao deletar o usuário</p>';
                                    }
                                }
                            } 
                    ?>
