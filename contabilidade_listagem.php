...
<html>
    ...
    <head>
        <title>Listagem de Documentos - Contabilidade</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div class="fora-menu">
            <div class="listagem-arquivos">
                ...
                <?php
                include ("lib/conexao.php");
                $sql_code = "SELECT * FROM arquivo WHERE id_categoria= 3";
                        ...
                        if ($sql_listagem == 0) {
                            ...
                            while ($listagem = $sql_exec->fetch_assoc()) {
                                ...
                                <tr>
                                    ...
                                    <td><?php if ($listagem['descricao'] == NULL) echo "-";
                        else $listagem['descricao'] ?></td>
                                    ...
                                    if ($usuario['privilegio'] == 1) {
                                        ...
                                        <td>
                                            <div class="botoes-comandos">
                                                <a href="contabilidade_alterar.php?id=<?php echo $listagem['id'] ?>"><button id="alterar">Alterar</button></a>
                                                <a href="contabilidade_excluir.php?id=<?php echo $listagem['id'] ?>"><button id="deletar">Excluir</button></a>
                                            </div>
                                        </td>
        <?php } ?>
                                </tr>
