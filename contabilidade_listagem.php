                            ...
                            if ($sql_listagem == 0) {
                                ...
                                while ($listagem = $sql_exec->fetch_assoc()) {
                                    ...
                                    <tr id="document-<?php echo $listagem['id'] ?>">
                                        ...
                                        <td><?php echo ($listagem['descricao'] == NULL) ? "-" : $listagem['descricao']; ?></td>
                                        ...
                                        <?php if ($usuario['privilegio'] == 1) { ?>
                                            <td>
                                                <div class="botoes-comandos">
                                                    <a href="contabilidade_alterar.php?id=<?php echo $listagem['id'] ?>"><button class="alterar">Alterar</button></a>
