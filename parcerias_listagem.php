...
<html>
    ...
    <head>
        <title>Listagem de Parcerias</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div class="fora-menu">
            <div class="listagem-arquivos">
                ...
                <?php
                include ("lib/conexao.php");
                $sql_code = "SELECT * FROM arquivo WHERE id_categoria= 1";
                                    ...
                                    if ($usuario['privilegio'] == 1) {
                                        ...
                                        <td>
                                            <div class="botoes-comandos">
                                                <a href="parcerias_alterar.php?id=<?php echo $listagem['id'] ?>"><button id="alterar">Alterar</button></a>
                                                <a href="parcerias_excluir.php?id=<?php echo $listagem['id'] ?>"><button id="deletar">Excluir</button></a>
                                            </div>
                                        </td>
                                    <?php } ?>
                                </tr>
