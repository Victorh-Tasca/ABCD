...
<html>
    ...
    <head>
        <title>Listagem de Documentos - Plano de Ação</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div class="fora-menu">
            <div class="listagem-arquivos">
                ...
                <?php
                include ("lib/conexao.php");
                $sql_code = "SELECT * FROM arquivo WHERE id_categoria= 5";
                                    ...
                                    if ($usuario['privilegio'] == 1) {
                                        ...
                                        <td>
                                            <div class="botoes-comandos">
                                                <a href="planoacao_alterar.php?id=<?php echo $listagem['id'] ?>"><button class="alterar">Alterar</button></a>
                                                <a href="planoacao_excluir.php?id=<?php echo $listagem['id'] ?>"><button class="cuidado">Excluir</button></a>
                                            </div>
                                        </td>
                                    <?php } ?>
                                </tr>
