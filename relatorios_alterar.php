                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            <div class="secao-column">
                                <div>
                                    ...
                                    <input type="text" name="nome" id="nome" autofocus value="<?php echo $doc['titulo_documento'] ?>">
                                    <label>Descrição:</label>
                                    <textarea name="descricao" id="descricao" cols="30" rows="10" ><?php echo $doc['descricao'] ?></textarea>
                                    ...
                                    <select name="categoria" >
                                        ...
                                        <?php
                                        $sql_code_categoria = "SELECT * FROM categoria  WHERE id <> 7 ORDER BY nome ASC";
        ...
        if (count($_POST) > 0) {
            if (isset($_POST['submeter'])) {
                ...
                if ($erro) {
                    ...
                    if ($deu_certo) {
                        echo '<p>Arquivo atualizado com sucesso</p>, <a href="relatoriosatividade_listagem.php">voltar</a> para página de listagem</p>';
