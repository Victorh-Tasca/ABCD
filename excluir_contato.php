...
$id = intval($_GET['id']);
$sql_code = "SELECT* FROM contato WHERE id='$id'";
    ...
    <body>
        ...
        <div class="fora-menu">
            ...
            <div class="descricao">
                ...
                <p>Escolha uma das opções abaixo para deletar ou não um contato no sistema da ABCD.</p>
            </div>
            ...
            <button type="submit" name="sim" id="deletar">Sim</button>
                        ...
                        <a href="listagem_contato.php"> <button type="submit" >Não</button></a>
                    ...
                    if (count($_POST) > 0) {
                        if (isset($_POST['sim'])) {
                                    ...
                                    if ($deu_certo) {
                                        echo '<p class="certo">Contato deletado com sucesso, <a href="listagem_contato.php">voltar</a> para página de listagem de contatos</p>';
                                        unset($_POST);
                                        die();
                                    } else {
                                        echo '<p class="error">Erro ao deletar contato</p>';
                                    }
                                }
                            } 
                    ?>
