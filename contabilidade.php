...
<html>
    ...
    <body>
        ...
        <header class="menu-inicial">
            <a href="../index.php"><img src="../img/ABCD.png" alt="" /></a>
            <nav>
                <ul class="menu-inicial">
                    ...
                    <li>
                        ...
                        <div id="dropDown3" onmouseover="funcao_dropdown3()" onmouseout="funcao_dropdown3()" class="dropdown-menu-inicial">
                            ...
                            <a href="RegularidadeFiscal.php">Regularidade Fiscal</a>
                            <a href="RelatoriosDeAtividades.php">Relatórios</a>
        ...
        <h1 class="titulo">Contabilidade</h1>

        <div class="espacotransp sombratransp">

            <h2 class="subtitulo">Documentos - Contabilidade</h2>
            <hr align="left">
            <table>
                <?php
