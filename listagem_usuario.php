    ...
    <body>
        ...
        <div class="menu-lateral">
            ...
            <div class="icons-menu-lateral">
                <a href="destruir_sessao.php">                <img src="img/logout.png" alt=""/></a>
            </div>
        </div>
        <div class="fora-menu">
                                    ...
                                    if ($usuario['privilegio'] == 1) {
                                        ...
                                        <td>
                                            <div class="botoes-comandos">
                                                <a href="alterar_usuario.php?id=<?php echo $listagem['id'] ?>"><button id="alterar">Alterar</button></a>
                                                <a href="excluir_usuario.php?id=<?php echo $listagem['id'] ?>"><button id="deletar">Excluir</button></a>
                                            </div>
                                        </td>
                                    <?php } ?>
                                </tr>
