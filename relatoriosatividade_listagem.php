...
<html>
    ...
    <head>
        <title>Listagem de Documentos - Relatórios</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div class="fora-menu">
            <div class="listagem-arquivos">
                ...
                <?php
                include ("lib/conexao.php");
                $sql_code = "SELECT * FROM arquivo WHERE id_categoria= 7";
                                    ...
                                    if ($usuario['privilegio'] == 1) {
                                        ...
                                        <td>
                                            <div class="botoes-comandos">
                                                <a href="relatorios_alterar.php?id=<?php echo $listagem['id'] ?>"><button id="alterar">Alterar</button></a>
                                                <a href="relatorios_excluir.php?id=<?php echo $listagem['id'] ?>"><button id="deletar">Excluir</button></a>
                                            </div>
                                        </td>
                                    <?php } ?>
                                </tr>
