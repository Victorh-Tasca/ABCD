    ...
    <body>
        ...
        <div class="fora-menu">
            ...
            <button type="submit" name="sim" id="deletar">Sim</button>
                        ...
                        <a href="documentos_listagem.php"> <button type="submit" >Não</button></a>
                    ...
                    if (count($_POST) > 0) {
                        if (isset($_POST['sim'])) {
                                    ...
                                    if ($deu_certo) {
                                        echo '<p class="certo">Documento deletado com sucesso, <a href="documentos_listagem.php">voltar</a> para página de listagem</p>';
                                        unset($_POST);
                                        die();
                                    } else {
