    ...
    <body>
        ...
        <div class="fora-menu">
            <section class=formulário>
                ...
                <a href="contabilidade_listagem.php"> <button type="submit" >Não</button></a>
        ...
        if (count($_POST) > 0) {
            if (isset($_POST['sim'])) {
                ...
                if ($deu_certo) {
                    ...
                    echo '<p class="certo">Arquivo deletado com sucesso, <a href="contabilidade_listagem.php">voltar</a> para página de listagem</p>';
                    unset($_POST);
                    die();
                } else {
